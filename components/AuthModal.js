  ...
  return (
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={e => e.stopPropagation()}>
        ...
        <div className={styles.logoSub}>Antique Research Tool</div>
        ...
        <button
          ...
          onClick={() => signIn('google', { callbackUrl: callbackUrl || '/scan' })}
        >
        ...
        <p className={styles.legal}>
          ...
          Scan results are research starting points only — not formal appraisals.
        </p>
      </div>
    </div>
  )
